...
추천 시스템과 인간 행동 분석 연구를 통해 사용자의 일상에 자연스럽게 스며드는 AI를 만드는 데 관심을 두고 있습니다. 대학원에서는 신호 처리와 VR 환경 생체 인증을 연구했으며, 이를 통해 인간 데이터를 기반으로 한 실용적인 AI의 가능성에 주목하게 되었습니다.
...
> **㈜팜킷 Artificial Intelligence Engineer** <br>
*2024년 9월 ~ 현재* <br>
이커머스 데이터를 활용한 추천 시스템 연구 및 파이프라인 구축

### 🎓 학력

> **상명대학교 대학원 지능정보공학과 석사 졸업** <br>
*2022년 9월 ~ 2024년 8월* <br>
**논문 제목**: *A study on the biometric authentication method using infrared periocular images captured in head-mounted display*<br>
